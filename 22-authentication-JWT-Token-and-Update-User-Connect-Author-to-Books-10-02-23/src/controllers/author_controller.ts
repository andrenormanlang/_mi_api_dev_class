...
import { getAuthor } from '../services/author_service'
import { createAuthor } from '../services/author_service'
...
export const show = async (req: Request, res: Response) => {
	...
	res.send({
		...
		debug("Error thrown when finding author with id %o: %o", req.params.bookId, err)
